...
$app->post('/api/Wordnik/searchWords', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['api_key','query','caseSensitive','includePartOfSpeech','excludePartOfSpeech','minCorpusCount','maxCorpusCount','minDictionaryCount','maxDictionaryCount','minLength','maxLength','skip','limit']
    ];
    ...
    $query_str = "http://api.wordnik.com:80/v4/words.json/search";
